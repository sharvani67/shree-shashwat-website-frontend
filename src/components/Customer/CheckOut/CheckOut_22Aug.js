...
const CheckoutPage = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Prepare common order data for Shiprocket
      const weightInKg = calculateTotalWeightInKg(cartItems);
      ...
      if (total_quantity >= 4) {
        shipping_charges = selectedPaymentMethod === "COD" ? codeCharge : 0;
        finalShippingPrice = 0;
      } else {
        shipping_charges = selectedPaymentMethod === "COD" ? shippingPrice + codeCharge : shippingPrice;
