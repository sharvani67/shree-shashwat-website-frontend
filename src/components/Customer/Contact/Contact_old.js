      ...
      <div className="contact-container container my-5">
        ...
        <div className="row">
          ...
          <div className="col-md-6 mb-4">
            ...
            <p className="paragraph">Email us or give us a call — we're here to help you with your inquiries.</p>


            <div className="row">
              <div className="col-md-6">
                <div className="contact-info-box phone shadow-sm p-3 mb-3 rounded d-flex align-items-start gap-3">
                  <i className="bi bi-telephone-fill fs-4 text-primary"></i>
                  <div>
                    <h6 className="mb-1 fw-bold">Phone</h6>
                    <p className="mb-1 fw-bold">
                      <a href="tel:+918971607888" target="_blank" rel="noopener noreferrer" className="text-dark text-decoration-none">
                        8971607888
                      </a> /
                      <a href="tel:+916363900869" target="_blank" rel="noopener noreferrer" className="text-dark text-decoration-none">
                        6363900869
                      </a>
                    </p>
                  </div>
              ...
              <div className="col-md-6">
                <div className="contact-info-box email shadow-sm p-3 mb-3 rounded d-flex align-items-start gap-3">
                  <i className="bi bi-envelope-fill fs-4 text-success"></i>
                  <div>
                    <h6 className="mb-1 fw-bold">Email</h6>
                    <p className="mb-1 fw-bold">
                      <a href="mailto:contact@southsutra.com" className="text-dark text-decoration-none">
              ...
              <div className="col-md-12">
                <div className="contact-info-box address shadow-sm p-3 mb-3 rounded d-flex align-items-start gap-3">
                  <i className="bi bi-geo-alt-fill fs-4 text-danger"></i>
                  <div>
                    <h6 className="mb-1 fw-bold">Address</h6>
                    <p className="mb-1 fw-bold">
                      <a
                        href="https://www.google.com/maps?q=INFAB+AGRO+FOODS+pvt+ltd+125/3+Kanminike+Village+Hejjala+Circle+South+Taluk+Bangalore-562109"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-dark text-decoration-none"
                      >
                        INFAB AGRO FOODS pvt ltd  #125/3 Kanminike Village Hejjala Circle South Taluk Bangalore-562109
                      </a>
                    </p>
                  </div>
                </div>
              ...
              <div className="col-md-12">
                <div className="map-section map">
                  ...
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3889.8744115208115!2d77.42518777507443!3d12.851387187452993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTLCsDUxJzA1LjAiTiA3N8KwMjUnNDAuMCJF!5e0!3m2!1sen!2sin!4v1748325097053!5m2!1sen!2sin"
