...
import Footer from '../Customer/Footer/Footer'; // ✅ Import Footer component
...
const Refundpolicy = () => {
  return (
    <>
      ...
      <div className="Refundpolicy-container container my-5" style={{ maxWidth: '900px', marginTop: '80px' }}>
        <div className="Refundpolicy-card shadow-lg rounded-4 border-0">
          <div className="Refundpolicy-header bg-danger text-white rounded-top p-4">
          ...
          <div className="Refundpolicy-body p-4" style={{ backgroundColor: '#f8f9fa', backgroundImage: 'linear-gradient(to bottom, #f8f9fa, #e9ecef)' }}>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaUndo className="me-2" />Return Eligibility Requirements:</h4>
            <ul>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaExclamationCircle className="me-2" />Additional Requirements for Returns:</h4>
            <ul>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaTimesCircle className="me-2" />Non-Returnable Circumstances:</h4>
            <ul>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaEnvelope className="me-2" />To start a return:</h4>
            <p>
              You can contact us at <a href="mailto:contact@southsutra.com" className="text-danger text-decoration-underline">contact@southsutra.com</a>. Please note that returns will need to be sent to the following address:
            </p>
            <p>
            ...
            <p>
              You can always contact us for any return process questions at <a href="mailto:contact@southsutra.com" className="text-danger text-decoration-underline">contact@southsutra.com</a>.
            </p>

            <h4 className="mt-4 mb-3 text-danger"><FaRegCheckCircle className="me-2" />Damages and Issues:</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaExclamationCircle className="me-2" />Exceptions / Non-returnable Items:</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaSyncAlt className="me-2" />Exchanges:</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaMoneyBillWave className="me-2" />Refunds:</h4>
            <p>
            ...
            <p>
              ...
              please contact us at <a href="mailto:contact@southsutra.com" className="text-danger text-decoration-underline">contact@southsutra.com</a>.
            </p>
          </div>
