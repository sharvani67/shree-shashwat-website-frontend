      ...
      <div className="container my-5" style={{ maxWidth: '900px', marginTop: '500px' }}>
        <div className="card shadow-lg rounded-4 border-0">
          ...
          <div className="card-body p-4" style={{ backgroundColor: '#f8f9fa', backgroundImage: 'linear-gradient(to bottom, #f8f9fa, #e9ecef)' }}>
            ...
            <p>
              If you have any questions about our shipping policy, please feel free to contact us at <a href="mailto:contact@southsutra.com" className="text-color text-decoration-underline">contact@southsutra.com</a> Our customer service team is available [Days and Hours of Operation] to assist you.
            </p>
          </div>
