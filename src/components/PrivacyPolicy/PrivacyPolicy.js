      ...
      <div className="container my-5" style={{ maxWidth: '900px', marginTop: '80px' }}>
        <div className="card shadow-lg rounded-4 border-0">
          ...
          <div className="card-body p-4" style={{ backgroundColor: '#f8f9fa', backgroundImage: 'linear-gradient(to bottom, #f8f9fa, #e9ecef)' }}>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaInfoCircle className="me-2" />Changes to This Privacy Policy</h4>
            <p>
              We may update this Privacy Policy from time to time, including to reflect changes to our practices or for other operational, legal, or regulatory reasons. We will post the revised Privacy Policy on the Site, update the "Last updated" date and take any other steps required by applicable law.
            </p>

            <h4 className="mt-4 mb-3 text-danger"><FaLock className="me-2" />How We Collect and Use Your Personal Information</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaLock className="me-2" />What Personal Information We Collect</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaEnvelope className="me-2" />How We Use Your Personal Information</h4>
            <ul>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaCookieBite className="me-2" />Cookies</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaGlobe className="me-2" />How We Disclose Personal Information</h4>
            <p>
...
<p className="mt-3">
 ...
 We do not use or disclose sensitive personal information for the purposes of inferring characteristics about you.
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaExclamationTriangle className="me-2" />User Generated Content</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaGlobe className="me-2" />Third Party Websites and Links</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaChild className="me-2" />Children's Data</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaShieldAlt className="me-2" />Security and Retention of Your Information</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaUserEdit className="me-2" />Your Rights and Choices</h4>
            <p>
...
<p>We will not discriminate against you for exercising any of these rights. We may need to collect information from you to verify your identity, such as your email address or account information, before providing a substantive response to the request. In accordance with applicable laws, You may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them to act on your behalf, and we may need you to verify your identity directly with us. We will respond to your request in a timely manner as required under applicable law.</p>
            <h4 className="mt-4 mb-3 text-danger"><FaUndo className="me-2" />Complaints</h4>
            <p>
              If you have complaints about how we process your personal information, please contact us using the contact details provided below. If you are not satisfied with our response to your complaint, depending on where you live you may have the right to appeal our decision by contacting us using the contact details set out below, or lodge your complaint with your local data protection authority.
            </p>

            <h4 className="mt-4 mb-3 text-danger"><FaGlobe className="me-2" />International Users</h4>
            <p>
            ...
            <h4 className="mt-4 mb-3 text-danger"><FaEnvelope className="me-2" />Contact</h4>
            <p>
              Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at <a href="mailto:contact@southsutra.com" className="text-danger text-decoration-underline">contact@southsutra.com</a> or contact us at <b>  INFAB AGRO FOODS Pvt Ltd,#125/3 Kanminike Village,
